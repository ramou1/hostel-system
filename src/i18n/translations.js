...
export const translations = {
  pt: {
    ...
    dashboard: {
      ...
      quickAddClient: "Adicionar cliente",
      quickAddRental: "Adicionar aluguel",
      showSales: "Mostrar vendas",
      hideSales: "Ocultar vendas",
    },
    clients: {
      ...
      room: "Quarto",
      locker: "Armário",
      selectLocker: "Selecione o armário",
      noLocker: "Sem armário",
      lockerPlaceholder: "Ex.: A-01",
      countryPlaceholder: "Ex.: Brasil",
      status: "Status",
      statusCheckedIn: "Hospedado",
      statusCheckedOut: "Check-out",
      checkedOutAt: "Data do check-out",
      checkout: "Fazer check-out",
      checkoutTitle: "Check-out do hóspede",
      checkoutDesc:
        "Confirme a saída. Você pode marcar quais aluguéis foram devolvidos.",
      returnAllRentals: "Devolver todos os aluguéis",
      noOpenRentals: "Este hóspede não tem aluguéis em aberto.",
      confirmCheckout: "Confirmar check-out",
      checkoutSuccessTitle: "Check-out concluído",
      checkoutSuccessDesc: "O hóspede foi marcado como check-out.",
      cpf: "CPF",
      country: "País",
      language: "Idioma",
    ...
    rooms: {
      ...
      clientsAutoHint:
        "A quantidade de clientes é atualizada automaticamente ao cadastrar ou fazer check-out.",
      types: {
        male: "Masculino",
        female: "Feminino",
        mixed: "Misto",
    ...
    hostel: {
      infoTitle: "Dados do hostel",
      infoSubtitle: "Cadastre e atualize as informações da sua unidade.",
      name: "Nome do hostel",
      email: "E-mail",
      phone: "Telefone",
      address: "Endereço",
      ...
      rules: "Regras do hostel",
      rulesHint: "Liste as regras da casa que os hóspedes devem seguir.",
      rulesPlaceholder: "Ex.: Silêncio após as 22h...",
      saveSuccessTitle: "Hostel atualizado",
      saveSuccessDesc: "As informações foram salvas com sucesso.",
      lockersTitle: "Armários",
      lockersSubtitle: "Opcional: cadastre armários e associe a hóspedes hospedados.",
      addLocker: "Adicionar armário",
      lockerCode: "Código",
      lockerClient: "Hóspede",
      lockerStatus: "Status",
      lockerOccupied: "Ocupado",
      lockerFree: "Livre",
      noClient: "Nenhum",
      assign: "Associar",
      lockersEmpty: "Nenhum armário cadastrado ainda.",
      lockerAddSuccessTitle: "Armário adicionado",
      lockerAddSuccessDesc: "O armário foi cadastrado com sucesso.",
      lockerAssignSuccessTitle: "Armário atualizado",
      lockerAssignSuccessDesc: "A associação com o hóspede foi salva.",
    },
    rentals: {
      searchPlaceholder: "Buscar aluguéis...",
      addNew: "Novo aluguel",
      addTitle: "Registrar aluguel",
      item: "Item",
      client: "Quem alugou",
      selectClient: "Selecione o hóspede",
      price: "Valor",
      rentedAt: "Data",
      empty: "Nenhum aluguel registrado.",
      addSuccessTitle: "Aluguel registrado",
      addSuccessDesc: "O item foi associado ao hóspede.",
      status: "Status",
      statusOpen: "Em aberto",
      statusReturned: "Devolvido",
      markReturned: "Marcar como devolvido",
      returnedTitle: "Devolução registrada",
      returnedDesc: "O item foi marcado como devolvido.",
      items: {
        towel: "Toalha",
        adapter: "Adaptador",
        padlock: "Cadeado",
  ...
  en: {
    ...
    clients: {
      ...
      noLocker: "No locker",
      lockerPlaceholder: "E.g.: A-01",
      countryPlaceholder: "E.g.: Brazil",
      status: "Status",
      statusCheckedIn: "Checked in",
      statusCheckedOut: "Checked out",
      checkedOutAt: "Check-out date",
      checkout: "Check out",
      checkoutTitle: "Guest check-out",
      checkoutDesc:
        "Confirm departure. You can mark which rentals were returned.",
      returnAllRentals: "Return all rentals",
      noOpenRentals: "This guest has no open rentals.",
      confirmCheckout: "Confirm check-out",
      checkoutSuccessTitle: "Check-out completed",
      checkoutSuccessDesc: "The guest has been marked as checked out.",
      cpf: "CPF",
      country: "Country",
      language: "Language",
    ...
    rooms: {
      ...
      clientsAutoHint:
        "Guest count is updated automatically when you add a client or check them out.",
      types: {
        male: "Male",
        female: "Female",
        mixed: "Mixed",
    ...
    hostel: {
      infoTitle: "Hostel details",
      infoSubtitle: "Register and update your unit information.",
      name: "Hostel name",
      email: "Email",
      phone: "Phone",
      address: "Address",
      ...
      rules: "House rules",
      rulesHint: "List the house rules guests should follow.",
      rulesPlaceholder: "E.g.: Quiet hours after 10pm...",
      saveSuccessTitle: "Hostel updated",
      saveSuccessDesc: "Your information was saved successfully.",
      lockersTitle: "Lockers",
      lockersSubtitle: "Optional: register lockers and assign them to guests.",
      addLocker: "Add locker",
      lockerCode: "Code",
      lockerClient: "Guest",
      lockerStatus: "Status",
      lockerOccupied: "Occupied",
      lockerFree: "Free",
      noClient: "None",
      assign: "Assign",
      lockersEmpty: "No lockers registered yet.",
      lockerAddSuccessTitle: "Locker added",
      lockerAddSuccessDesc: "The locker was registered successfully.",
      lockerAssignSuccessTitle: "Locker updated",
      lockerAssignSuccessDesc: "The guest assignment was saved.",
    },
    rentals: {
      searchPlaceholder: "Search rentals...",
      addNew: "New rental",
      addTitle: "Register rental",
      item: "Item",
      client: "Rented by",
      selectClient: "Select guest",
      price: "Price",
      rentedAt: "Date",
      empty: "No rentals registered.",
      addSuccessTitle: "Rental registered",
      addSuccessDesc: "The item was linked to the guest.",
      status: "Status",
      statusOpen: "Open",
      statusReturned: "Returned",
      markReturned: "Mark as returned",
      returnedTitle: "Return registered",
      returnedDesc: "The item was marked as returned.",
      items: {
        towel: "Towel",
        adapter: "Adapter",
        padlock: "Padlock",
